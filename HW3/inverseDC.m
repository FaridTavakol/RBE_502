...
function [ dx ] = inverseDC( t,x,link_1,link_2,integral_term)
...
%       initiating time deltaT for integration
        ...
        if integral_term == false
            ...
            % Acc With the addition of the integral term
            Acc = Acc_d -Kp*e -Kd*de - Ki*(e*deltaT);%the term e*T calculates the area under the graph of e vs Time
            %to get the integration of error over time
